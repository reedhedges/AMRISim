...
// Error macros
#define RTK_PRINT_ERR(m)         printf("\rstg_rtk error : %s %s\n  "m"\n", \
                                    __FILE__, __FUNCTION__)
#define RTK_PRINT_ERR1(m, a)     printf("\rstg_rtk error : %s %s\n  "m"\n", \
                                    __FILE__, __FUNCTION__, a)
#define RTK_PRINT_ERR2(m, a, b)  printf("\rstg_rtk error : %s %s\n  "m"\n", \
                                    __FILE__, __FUNCTION__, a, b)

// Warning macros
#define RTK_PRINT_WARN(m)         printf("\rstg_rtk warning : %s %s\n  "m"\n", \
                                     __FILE__, __FUNCTION__)
#define RTK_PRINT_WARN1(m, a)     printf("\rstg_rtk warning : %s %s\n  "m"\n", \
                                     __FILE__, __FUNCTION__, a)
#define RTK_PRINT_WARN2(m, a, b)  printf("\rstg_rtk warning : %s %s\n  "m"\n", \
                                     __FILE__, __FUNCTION__, a, b)
#define RTK_PRINT_WARN3(m, a, b, c) printf("\rstg_rtk warning : %s %s\n  "m"\n", \
                                     __FILE__, __FUNCTION__, a, b, c)

// Message macros
#define RTK_PRINT_MSG(m) printf("stg_rtk msg : %s :\n  "m"\n", __FILE__)
#define RTK_PRINT_MSG1(m, a) printf("stg_rtk msg : %s :\n  "m"\n", __FILE__, a)
#define RTK_PRINT_MSG2(m, a, b) printf("stg_rtk msg : %s :\n  "m"\n", __FILE__, a, b)
