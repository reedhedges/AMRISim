...
#define STG_LAYER_BACKGROUND 1   // matches RTK background layer 
...
#define STG_LAYER_LASERGEOM 28
#define STG_LAYER_LASERDATA 27
#define STG_LAYER_LASERCONFIG 29
...
#define STG_BUMPERS_COLOR "black"
#define STG_BUMPERS_BRIGHT_COLOR "violet"
